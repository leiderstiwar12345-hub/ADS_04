...
public class Cajero {
    ...
    private void ConsignarDinero() {
        try {
            String consigna = idvalidacion();
            JOptionPane.showMessageDialog(null, "ADVERTENCIA: El cajero no recibe monedas"
                    , "Recuerde que no se reciben billetes menores a 20.000 \n", JOptionPane.WARNING_MESSAGE);
            String Ds = JOptionPane.showInputDialog(null, "ingrese la cantidad a consignar", "CONSIGNAR DINERO"
                    , JOptionPane.INFORMATION_MESSAGE);
            ...
            mensaje2.append(consigna)
                    .append("Saldo Actual: \n" + saldo)
                    .append(String.format("$, d", saldo));
            JOptionPane.showMessageDialog(null, mensaje2, "consignar dinero"
                    , JOptionPane.INFORMATION_MESSAGE);
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(null, " debes ingresar solo numero"
